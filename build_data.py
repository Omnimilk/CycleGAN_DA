...
#Usage: e.g: python build_data.py --X_input_dir "sim_images_a1_low_var" --X_output_file "sim_images_a1_low_var.tfrecords"
...
tf.flags.DEFINE_string('X_input_dir', '','X input directory')
tf.flags.DEFINE_string('X_output_file', '','X output tfrecords file')
